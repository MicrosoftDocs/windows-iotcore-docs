...
Note that this version of Limpet.exe should not be shipped with your final product. Instead, you need to build the open source project, sign it, and package it with your image.
...
Note that this version of the tools should not be shipped with your final product. Instead, you need to build the open source project, sign it, and package it with your image.
