...
Setting up WiFi using wireless profiles is supported in Windows 10 IoT Core. See [MSDN](/windows/win32/nativewifi/wireless-profile-samples) for details and examples.
