...
Check out [Getting Started with CE App Container - need to insert correct link](https://docs.microsoft.com/) for a step-by-step guide that will walk you through your migration journey.
