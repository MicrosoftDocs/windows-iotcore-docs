...
19. Install the [Azure CLI](/cli/azure/install-azure-cli?view=azure-cli-latest&preserve-view=true) (or use the [Azure Cloud Shell](https://shell.azure.com/)) and use it to [create an Azure IoT Hub](/cli/azure/iot/hub?view=azure-cli-latest#az-iot-hub-create&preserve-view=true).
...
20. Add the IoT Extension to the Azure CLI, and then [register a device identity](/cli/azure/ext/azure-cli-iot-ext/iot/hub/device-identity?view=azure-cli-latest#ext-azure-cli-iot-ext-az-iot-hub-device-identity-create&preserve-view=true)
...
21. [Retrieve your Device Connection String](/cli/azure/ext/azure-cli-iot-ext/iot/hub/device-identity?view=azure-cli-latest#ext-azure-cli-iot-ext-az-iot-hub-device-identity-show-connection-string&preserve-view=true) using the Azure CLI
...
22. [Begin monitoring for telemetry](/cli/azure/ext/azure-cli-iot-ext/iot/hub?view=azure-cli-latest#ext-azure-cli-iot-ext-az-iot-hub-monitor-events&preserve-view=true) on your IoT Hub using the Azure CLI
