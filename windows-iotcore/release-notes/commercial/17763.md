...
> [!IMPORTANT]
> If you're using the [October 2018 Update](/windows/iot-core/release-notes/commercial/october2018update.md), please use this release instead. We have found that there are known issues that affect users of the October 2018 Update. 
...
#### USB Keyboards  
Some USB keyboards and mice may not work on IoT Core. Use a different keyboard or mouse. A list of validated peripheral devices can be found in the [documentation here](/windows/iot-core/learn-about-hardware/hardwarecompatlist.md).
