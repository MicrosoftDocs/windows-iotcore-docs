...
ms.date: 02/02/2018
ms.topic: article
description: Read and learn about what's new in Windows Insider Build Number 17083.
keywords: windows iot, Windows Insider, release notes
---

# Release Notes for Build 17083
_Build Number 17083. February 2018_
...
The Intel Joule requires a firmware update to properly load Windows IoT Core. Please follow the install process detailed in the [Get Started flow](https://developer.microsoft.com/en-us/windows/iot/getstarted/prototype/setupdevice) to use IoT Core with Joule. 
...
* [Adding a file and a registry setting to an image](https://docs.microsoft.com/en-us/windows-hardware/manufacture/iot/add-a-registry-setting-to-an-image)
