...
<tr class="odd">
<td align="left"><p>[OEM License Requirements](https://docs.microsoft.com/en-us/windows-hardware/manufacture/iot/license-requirements)</p></td>
<td align="left"><p>Sign the OEM license agreement and learn more about other requirements for commercialization.</p></td>
</tr>

<tr class="odd">
<td align="left"><p>[Commercialization FAQ](https://docs.microsoft.com/en-us/windows-hardware/manufacture/iot/commercializationfaq)</p></td>
<td align="left"><p>Read some of the frequently-asked questions regarding commercializing for Windows 10 IoT.</p></td>
</tr>

<tr class="odd">
<td align="left"><p>[Create board supported packages](https://docs.microsoft.com/en-us/windows-hardware/manufacture/iot/create-a-new-bsp)</p></td>
<td align="left"><p>Learn how to create board supported packages (BSPs) for Windows 10 IoT Core.</p></td>
</tr>

<tr class="odd">
<td align="left"><p>[Create and install a package](https://docs.microsoft.com/en-us/windows-hardware/manufacture/iot/create-install-package)</p></td>
...
<tr class="odd">
<td align="left"><p>[Installing and servicing apps](https://docs.microsoft.com/en-us/windows-hardware/service/iot/servicing-msstore)</p></td>
