...
* You can now run the application.  Simply open a PowerShell/SSH connection (instructions can be found [here for powershell](../connect-your-device/PowerShell) and [here for SSH](../connect-your-device/SSH)) and enter the Remote Command you specified above.
