...
4. While holding down the volume up (+) button, power the device on. The device - when connected to a display - will show the image of a hammer, a lightning bolt, and a cog.
