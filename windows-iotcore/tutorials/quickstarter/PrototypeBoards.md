...
> [!NOTE]
> The Raspberry Pi platform has limited compatability with Windows 10 IoT Core. Please view the release Readme for more information. For a more complete Windows 10 IoT Core experience, please use a DragonBoard, Up2 Board or NXP device. 
