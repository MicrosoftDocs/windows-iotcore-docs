...
* A board with the latest version of Windows 10 IoT Core Insider Preview installed. Follow the [Get Started guide](../getstarted.md) to get the IoT Dashboard app and install Windows 10 IoT Core.
