...
> | Part Name / No. | Compatible Boards | Description | Microsoft Verified | Relevant Links | Notes |
> |----------------|-------------------|-------------|--------|------------------------------|------------------------------------|
> | Microsoft Lifecam 3000 USB Camera | RPi2/RPi3, MBM | USB Webcam | |  [Home Security Camera Project](https://developer.microsoft.com/en-us/windows/iot/samples/webcamapp) | Limited to less than 5 frames per second, no known performance workarounds. |
